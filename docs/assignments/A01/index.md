...
b) The mechanical advantage is the torque produced by the lever. It can be shown in the equation \(\tau =F_{\text{input}}\cdot L_{\text{input}}=F_{\text{nose}}\cdot L_{\text{fulcrum}}\)
